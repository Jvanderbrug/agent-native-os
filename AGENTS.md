# My Agent OS — Codex Context File

> This is YOUR AGENTS.md. Fill it in during the workshop.
> The more you put here, the more useful Codex becomes.
...
1. [Goal 1 — be specific. "Learn to use Codex" is vague. "Set up Gmail integration so Codex can draft my email responses" is specific.]
2. [Goal 2]
3. [Goal 3]
...
[Be honest. "They feel like search engines, not assistants" or "I never know what to ask" or "I can't trust the output" — this helps Codex understand your starting point.]

---

## My Autonomy Level

> This controls how much Codex checks in vs. acts independently.
> Start here during the workshop. Adjust as you get comfortable.

**Current setting: Director's Cut (Safe Mode)**

This means:
- Codex will always tell you what it's about to do before doing it
...
**When I ask a question:** [How should Codex respond? e.g., "Give me options, not just one answer" or "Just tell me the best path, don't overwhelm me with choices"]

**Tone:** [How should Codex talk to you? e.g., Direct and businesslike / Warm and collaborative / Casual like a smart coworker]
...
[Any terms, acronyms, or phrases Codex should know. e.g., "In real estate, we refer to..."]
...
> Codex works better when it knows who's who.
...
> Codex will reference this when it helps.
